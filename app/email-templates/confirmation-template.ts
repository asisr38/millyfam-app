/**
 * Generates HTML content for confirmation emails sent to users who submit the contact form
 */
export function generateConfirmationEmail(name: string): string {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
/**
 * Generates plain text content for confirmation emails (fallback for email clients that don't support HTML)
 */
export function generateConfirmationEmailText(name: string): string {
  return `
THANK YOU FOR CONTACTING MILLYFAM
