...
export default function Pricing() {
  return (
    <section id="pricing" className="w-full py-6 md:py-10 lg:py-12 bg-zinc-900">
      <div className="container mx-auto px-4 md:px-6 max-w-6xl">
        ...
        <div className="mx-auto mt-6 md:mt-8 max-w-[90%] md:max-w-md space-y-4 rounded-xl border border-zinc-800 p-4 md:p-6">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-2 md:gap-0 pb-2">
